  ...
  return (
    <div className="studio-shell">
      <aside className={`sidebar ${open ? "sidebar--open" : ""}`}>
        <div className="brand"><span>SU</span><div><strong>Studio UI</strong><small>v0.7.0</small></div><button className="mobile-close" onClick={() => setOpen(false)} aria-label="Close navigation"><X size={20}/></button></div>
