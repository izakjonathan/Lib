...
export function ReleasePage() {
  ...
  return <div className="release-page">
    <section className="release-hero"><span>Stable release</span><h1>Studio UI v1.0.0</h1><p>The first stable baseline for composing client websites and applications from documented, locally owned React components.</p><button onClick={downloadManifest}><Download size={17}/> Download manifest</button></section>
