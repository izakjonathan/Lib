  ...
  return (
    <StudioShell>
      <section className="hero" id="overview">
        <div><span className="hero-kicker"><Sparkles size={15}/> Business components release</span><h1>Browse, test and reuse your own interface library.</h1><p>Studio UI now adds customer, invoice, booking, notification, file-upload and workflow patterns for assembling real client applications from tested local components.</p><div className="hero-actions"><a className="primary-link" href="#library">Browse library <ArrowRight size={17}/></a><a className="secondary-link" href="#foundation">View foundation</a></div></div>
        <div className="hero-panel"><div><Layers3/><strong>44 documented components</strong><span>Dedicated detail pages</span></div><div><ShieldCheck/><strong>Preview controls</strong><span>Desktop, tablet and mobile</span></div><div><ChartNoAxesCombined/><strong>Searchable library</strong><span>Ready to expand release by release</span></div></div>
      </section>
