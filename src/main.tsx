  ...
  return (
    <StudioShell>
      <section className="hero" id="overview">
        <div><span className="hero-kicker"><Sparkles size={15}/> Component browser release</span><h1>Browse, test and reuse your own interface library.</h1><p>Studio UI turns the component collection into a searchable internal product with dedicated documentation, responsive previews and copy-ready usage examples.</p><div className="hero-actions"><a className="primary-link" href="#library">Browse library <ArrowRight size={17}/></a><a className="secondary-link" href="#foundation">View foundation</a></div></div>
