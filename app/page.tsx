...
export default function Home() {
  return <StudioShell>
    <section className="hero" id="overview">
      <div><span className="hero-kicker"><Sparkles size={15}/> Component browser release</span><h1>Browse, test and reuse your own interface library.</h1><p>Studio UI now turns the component collection into a searchable internal product with dedicated documentation, responsive previews and copy-ready usage examples.</p><div className="hero-actions"><a className="primary-link" href="#library">Browse library <ArrowRight size={17}/></a><a className="secondary-link" href="#foundation">View foundation</a></div></div>
      <div className="hero-panel"><div><Layers3/><strong>7 documented components</strong><span>Dedicated detail pages</span></div><div><ShieldCheck/><strong>Preview controls</strong><span>Desktop, tablet and mobile</span></div><div><ChartNoAxesCombined/><strong>Searchable library</strong><span>Ready to expand release by release</span></div></div>
    </section>
    <section className="content-section" id="foundation"><div className="section-header"><span>Foundation</span><h2>Consistent tokens and reusable APIs</h2><p>Shared colour, spacing, radius, typography and elevation decisions continue to control the visual language.</p></div><div className="token-grid"><div><span>Background</span><b className="swatch swatch--bg"/></div><div><span>Surface</span><b className="swatch swatch--surface"/></div><div><span>Accent</span><b className="swatch swatch--accent"/></div><div><span>Success</span><b className="swatch swatch--success"/></div><div><span>Radius</span><strong>8 / 14 / 22</strong></div><div><span>Spacing</span><strong>4 / 8 / 12 / 16 / 24</strong></div></div></section>
